  ...
  return (
    <div data-component-id={`product-${product.id}`} className="relative perspective-1000">
      ...
      >
        ...
        >
          <span className="text-[#ff003c] font-black text-lg font-orbitron">{currencySymbol}{product.price}</span>
        </div>
    ...
    <div className="flex flex-col w-full bg-[#050505] text-[#ededed] pt-32 min-h-screen relative overflow-hidden">
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto w-full mb-16 relative z-30">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          ...
          >
            <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter text-[#00f0ff] font-orbitron drop-shadow-[0_0_15px_rgba(0,240,255,0.5)] whitespace-pre-line">
              {shopTitle.replace(" ", "\n")}
            </h1>
