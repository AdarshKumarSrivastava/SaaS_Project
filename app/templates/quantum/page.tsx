          ...
          <div className="w-full md:w-1/2 flex flex-col items-start z-20">
            ...
            >
              ...
              <h1 className="font-playfair text-6xl md:text-8xl lg:text-[120px] leading-[0.9] font-bold text-[#121212] mb-8 tracking-tighter">
                <AnimatedText text={word1} />
                <AnimatedText text={word2} className="text-[#111111] italic pr-4" />
                <AnimatedText text={word3} />
              </h1>
            ...
            >
              ...
              <div>
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="font-inter font-medium text-lg">{currencySymbol}{product.price.toFixed(2)}</span>
                </div>
