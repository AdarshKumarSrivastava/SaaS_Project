...
export default function CanvasCartPage() {
  ...
  const shipping = totalPrice > 0 ? 15.00 : 0;
          ...
          <div className="p-6 md:p-12 lg:sticky lg:top-32">
            ...
            <div className="space-y-6 mb-12">
              <div className="flex justify-between text-[10px] tracking-[0.2em] uppercase text-white/50">
                <span>Subtotal</span>
                <span className="font-mono text-white/80 tracking-widest">{currencySymbol}{totalPrice.toFixed(2)}</span>
              </div>
              <div className="flex justify-between text-[10px] tracking-[0.2em] uppercase text-white/50">
                <span>Shipping</span>
                <span className="font-mono text-white/80 tracking-widest">{shipping === 0 ? "Free" : `${currencySymbol}${shipping.toFixed(2)}`}</span>
              </div>
              <div className="flex justify-between text-[10px] tracking-[0.2em] uppercase text-white/50">
                <span>Tax (8%)</span>
                <span className="font-mono text-white/80 tracking-widest">{currencySymbol}{tax.toFixed(2)}</span>
              </div>
            </div>
            ...
            <div className="border-t border-white/20 pt-8 mb-16">
              <div className="flex justify-between items-end">
                ...
                <span className="font-serif text-4xl text-white tracking-tighter">{currencySymbol}{finalTotal.toFixed(2)}</span>
              </div>
            </div>
