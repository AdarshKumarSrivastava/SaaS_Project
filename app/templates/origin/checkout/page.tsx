        ...
        <div className="max-w-[600px] mx-auto">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="mobile" className="text-xs font-bold uppercase tracking-widest text-[#402c21]/80">Phone Number</label>
                <input 
                  type="tel" 
                  id="mobile" 
                  required
...
<div className="flex flex-col gap-2">
                <label htmlFor="address" className="text-xs font-bold uppercase tracking-widest text-[#402c21]/80">Landmark (Optional)</label>
                <textarea 
                  id="landmark" 
      ...
      <div className="w-full bg-[#fdfbf7] min-h-screen pt-12 pb-32 px-6 md:px-12 text-[#402c21]">
        <div className="max-w-[600px] mx-auto">
          ...
          >
            ...
            {shippingDetails.landmark && <p className="text-sm text-[#402c21]/60 whitespace-pre-line leading-relaxed">Landmark: {shippingDetails.landmark}</p>}
            </div>
