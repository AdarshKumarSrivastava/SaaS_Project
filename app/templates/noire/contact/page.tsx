...
export default function StarterContactPage() {
  ...
  return (
    <div className="px-6 py-24 md:py-32 max-w-2xl mx-auto w-full flex flex-col items-center">
      ...
      >
        {tPreTitle && (
          <span className="block text-xs font-bold uppercase tracking-widest text-[#FF4D00] mb-4">
            {tPreTitle}
          </span>
        )}
        ...
        <p className="text-black/50 text-sm max-w-md mx-auto">
          We usually respond within 24 hours at {tEmail}. You can also reach us at {tPhone}.
        </p>
      </motion.div>
