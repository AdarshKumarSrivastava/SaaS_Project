  ...
  return (
    <div className="flex flex-col w-full bg-[#0a0a0a]" ref={containerRef}>
      ...
      <section className="py-12 border-y border-white/10 bg-white/5 overflow-hidden whitespace-nowrap flex items-center">
        ...
        >
          <span>{marqueeText1}</span> <span className="text-[#d4af37]">•</span>
          <span>{marqueeText2}</span> <span className="text-[#d4af37]">•</span>
          <span>{marqueeText3}</span> <span className="text-[#d4af37]">•</span>
          <span>{marqueeText1}</span> <span className="text-[#d4af37]">•</span>
          <span>{marqueeText2}</span> <span className="text-[#d4af37]">•</span>
          <span>{marqueeText3}</span> <span className="text-[#d4af37]">•</span>
        </motion.div>
